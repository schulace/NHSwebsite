...
//
//	Methods: getDbInfo(), insertToDb(), insertToDb(String json), getUserCount(), getFromDb(String field, String value)
...
public class Mongoconnect {
	...
	public static String getfromdb(String field, String value){//for example, getfromdb(username, john);
		MongoCollection<Document> collection = getConnection();//retrieve a collection
